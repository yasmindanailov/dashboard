...
> **Empieza por F0** (`redesign/f0-tokens`): tokens slate + arreglar `#635BFF`/tokens rotos (bugs reales hoy) + iconos SVG/fin de emojis (D1) + **partir `api.ts`** (2197 LOC → dir `lib/api/` con barrel, cero churn). Sprints **15D / Cuenta / 12 = MERGED** (histórico abajo). Estado de gaps go-live: [`90-meta/audit-2026-06-25.md §0`](../90-meta/audit-2026-06-25.md).
