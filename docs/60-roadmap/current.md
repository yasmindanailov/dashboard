...
> **Progreso:** **F0 ✅ · F1a/F1c/F1d ✅ · F2 ✅** (todo en ramas, sin mergear aún). **F0+F1** → [`bitácora F0+F1`](../90-meta/ui-redesign-bitacora-2026-06-27.md). **F2 (shells cliente+admin, rama `redesign/f2-shells`) ✅ CÓDIGO-COMPLETO 2026-06-27** (12 commits, verde: typecheck+lint+48 tests+build+screenshots Playwright de ambos shells) → [`bitácora F2`](../90-meta/ui-redesign-bitacora-f2-2026-06-27.md). Decisiones Yasmin: admin=7 Operaciones (plataforma+Equipo→cards Settings F4), cliente=6 items, ⌘K solo admin. **🆕 F3·E12 (macros / respuestas guardadas) ✅ CÓDIGO-COMPLETO** (2026-06-29, rama `redesign/f3-macros` **desde master**, independiente de las verticales apiladas): módulo backend `response-templates` (biblioteca de EQUIPO, nuevo `Subject.ResponseTemplate`, FK `created_by` SetNull) + picker "Respuestas guardadas" en el composer del workspace de chats (1:1 mockup) + gestor CRUD con DS. Verde: back (typecheck+lint+**1403** unit+boot **4/4**) y front (typecheck+lint+**51** unit) → [`bitácora E12`](../90-meta/ui-redesign-bitacora-f3-e12-2026-06-29.md). _Falta (Yasmin): smoke visual + merge._ **Siguiente:** resto **F3** (Stripe E6 [aplazado tras el diseño], IA E13) y **F4** (reskin página a página, incl. hub Settings con cards de plataforma+Equipo). Sprints **15D / Cuenta / 12 = MERGED** (histórico abajo). Estado de gaps go-live: [`90-meta/audit-2026-06-25.md §0`](../90-meta/audit-2026-06-25.md).
