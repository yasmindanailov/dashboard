...
| 15D.II.S | Buscador rico | `suggest-names v5` + bulk multi-nombre (IDN opcional → v1.1). Congela firma `suggestDomainNames?()`. | ⬜ **(siguiente)** |
| 15D.II.G | Cierre core | Smoke OT&E real (transfer/suggest) + E2E del flujo transfer + docs. | ⬜ |
