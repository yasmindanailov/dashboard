...
**Diferido consciente:** Knowledge Base · branding en footer de emails (render Handlebars sin layout común) · logo vectorial (PDFKit sólo PNG/JPG) · secciones no catalogadas (fiscal, plantilla PDF). **Falta (Yasmin):** smoke manual del editor en el dashboard.
