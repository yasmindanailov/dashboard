...
> **Outbox Pattern:** ✅ **5 eventos** — `invoice.created/paid/failed/overdue` + `domain.registered` (15D.D). Pendientes `service.*` y `partner.*` (bajo P-DEPLOY) — ADR-033 + auditoría 2026-06-21 (MEDIUM-1: `service.*` ya accionable).
